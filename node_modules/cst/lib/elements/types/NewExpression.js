...
var NewExpression = function (_Expression) {
    (0, _inherits3.default)(NewExpression, _Expression);

    function NewExpression(childNodes) {
    ...
    (0, _createClass3.default)(NewExpression, [{
        key: '_acceptChildren',
